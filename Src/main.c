...
static void MX_NVIC_Init(void)
{
  ...
  NVIC_SetPriority(TIM1_BRK_TIM15_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),6, 0));
...
static void MX_TIM1_Init(void)
{
  ...
  /* TIM1_CH4 Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_CHANNEL_1, LL_DMAMUX_REQ_TIM1_CH4);
...
static void MX_TIM7_Init(void)
{
  ...
  TIM_InitStruct.Autoreload = 42499;
